	...
	setTimeout(function() {	
		...
		for (let i=0; i<mp_payload.length; i++) {
			...
			if (mp_payload[i].nometanet == "yes" && mp_payload[i].newCounter == "no") {
				...
				console.log("add number preparation " + i);
...
function mp_loadButton(word) {
	...
	if (object.paywall == "yes") {
		...
		if (typeof mp_buys !== "undefined") {
			if (object.nometanet !== "yes" && mp_buys !== 0) {
				document.getElementById("mp_counter1").innerHTML = numbercountformat1 + "<span class='icon'>&#x1F48E;</span>" + mp_buys + " buyers</span>" + sharingWord1 + "<br /><a href='https://mediopay.com/bsv-how' target='_blank'>Don't know how to pay? Learn and get free BSV!</a></span>";
		   }
		   else {
		   	document.getElementById("mp_counter1").innerHTML = numbercountformat1 + "<span class='icon'>&#x1F48E;</span>" + mp_buys + " buyers</span>" + sharingWord1 + "<br /><a href='https://mediopay.com/bsv-how' target='_blank'>Don't know how to pay? Learn and get free BSV!</a></span>";
			...
			document.getElementById("mp_counter1").innerHTML = numbercountformat1 + "  <span class='icon'>&#x1F48E;</span> 0 buyers</span> " + sharingWord1 + "<br /><a href='https://mediopay.com/bsv-how' target='_blank'>Don't know how to pay? Learn and get free BSV!</a></span>";
		}
		}
	...
	if (object.tip == "yes") {
		...
		paymentLabel = "Tip";
		mp_element = "tbutton";
		if (typeof object.mp_tips !== "undefined" && object.mp_tips.length > 0) {			
			mp_tips = object.tips;
		}
		if (typeof mp_tips !== "undefined") {
			if (object.nometanet !== "yes" && mp_tips !== 0) {
				document.getElementById("counterTips").innerHTML = numbercountformat2 + " <span class='icon'>&#10084;</span>" + mp_tips + " tips</span>" + sharingWord3 + "<br /><a href='https://mediopay.com/bsv-how' target='_blank'>Don't know how to pay? Learn and get free BSV!</a></div>";
			}
			else {
				document.getElementById("counterTips").innerHTML = numbercountformat2 + " <span class='icon'>&#10084;</span>" + mp_tips + " tips</span>" + sharingWord3 + "<br /><a href='https://mediopay.com/bsv-how' target='_blank'>Don't know how to pay? Learn and get free BSV!</a></div>";
			}
			...
			document.getElementById("counterTips").innerHTML = numbercountformat2 + " <span class='icon'>&#10084;</span> 0 tips</span>" + sharingWord3 + "<br /><a href='https://mediopay.com/bsv-how' target='_blank'>Don't know how to pay? Learn and get free BSV!</a></div>";
		}
		tipreturn = object.returndata;
	}
	if (object.paywall2 == "yes") {
		console.log("define mp_buys2");
		mp_buys2 = object.number;
		if (typeof object.mp_buys2 !== "undefined" && object.mp_buys2.length > 0) {			
			mp_buys2 = object.mp_buys2;
		}
		console.log(mp_buys2);
		...
		if (typeof mp_buys2 !== "undefined") {
			if (mp_buys2 == 0) {
				document.getElementById("mp_counter2").innerHTML = numbercountformat3 + "<span class='icon'>&#x1F48E;</span>" + mp_buys2 + " buyers</span>" + sharingWord2 + "<br /><a href='https://mediopay.com/bsv-how' target='_blank'>Don't know how to pay? Learn and get free BSV!</a></span>";
			}
			else {
				document.getElementById("mp_counter2").innerHTML = numbercountformat3 + "<span class='icon'>&#x1F48E;</span>" + mp_buys2 + " buyers</span>" + sharingWord2 + "<br /><a href='https://mediopay.com/bsv-how' target='_blank'>Don't know how to pay? Learn and get free BSV!</a></span>";
			}
			...
			document.getElementById("mp_counter2").innerHTML = numbercountformat3 + " <span class='icon'>&#x1F48E;</span> 0 buyers</span>" + sharingWord2 + "<br /><a href='https://mediopay.com/bsv-how' target='_blank'>Don't know how to pay? Learn and get free BSV!</a></span>";
		}
		}	
	...
	if (typeof object.firstPartner !== "undefined" && object.sharing >= 0.1)  {
		outPuts1st = {
	...
	if (typeof object.secondPartner !== "undefined" && object.sharing >= 0.2)  {
		outPuts2nd = {
	...
	if (typeof object.thirdPartner !== "undefined" && object.sharing >= 0.3)  {
		outPuts3rd = {
	...
	if (typeof object.fourthPartner !== "undefined" && object.sharing >= 0.4)  {
		outPuts4th = {
  ...
  console.log(outPuts);
   	...
   	onPayment: function (payment) {
			if (typeof paywallreturn1 != "undefined") {
				if (payment.paymentOutputs[0].script == paywallreturn1) {
					mp_handleSuccessfulPayment1(payment, object);
				}
			}
         if (typeof tipreturn != "undefined") {
     		...
     		if (typeof paywallreturn2 != "undefined") {
				if (payment.paymentOutputs[0].script == paywallreturn2) {
					mp_handleSuccessfulPayment2(payment, object);
				}
			}
     	},
   ...
   console.log(mbobject);
	...
	if ((object.typenumber == "100101" || object.typenumber == "100102") && typeof object.cookie !== "undefined") {
	}
	else {
