...
function mp_querryPlanaria(object) {
	...
	if (mp_payload[0].nometanet == "yes" && mp_payload[0].newCounter == "no") {
	...
	else if (mp_payload[0].newCounter == "yes" || mp_payload[0].newCounter2 == "yes")  {
		for (let i=0;i<mp_payload.length;i++) {
			if ((mp_payload[i].newCounter == "yes" && mp_payload[i].paywall == "yes") || (mp_payload[i].newCounter2 == "yes" && mp_payload[i].paywall2 == "yes") || (mp_payload[i].newCounter == "yes" && mp_payload[i].tip) == "yes" ) {
...
function mp_loadButton(word) {
	...
	if (object.tip == "yes") {
		...
		paymentLabel = "Tip";
		mp_element = "tbutton";
		if (typeof object.mp_tips !== "undefined" && object.tips.length > 0) {			
			mp_tips = object.tips;
		}
