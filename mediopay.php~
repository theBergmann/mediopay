<?php
/*
 * Plugin Name: Bitcoin SV Paywall Plugin for Wordpress
 * Description: This plugin allows [cp-hide-button] shortcode with Bitcoin SV / Money Button
 * Author: Vibe Internet Team
 * Author URI: https://vibeit.com.au
 */
